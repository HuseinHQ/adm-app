          ...
          <div class="w-1/2">
            ...
            <div class="mr-3 mt-3">
              ...
              <select
                ...
                v-model="regional"
              >
                <option value="" selected disabled class="unselect">
                  Select Region
                </option>
                <option value="BALNUS" :selected="regional === 'BALNUS'">BALNUS</option>
                <option value="JATIM" :selected="regional === 'JATIM'">JATIM</option>
              </select>
            </div>
