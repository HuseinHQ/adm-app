              ...
              <form action="" class="flex flex-row flex-auto ml-6 mr-6 pb-6">
                  ...
                  <div class="w-1/2">
                    <div class="mr3">
                      ...
                      <input class="border border-slate-500 text-black text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-[100%] px-4 py-[10px] placeholder:text-slate-300" type="password" required name="password" id="password" placeholder="e.g ineedadn123" v-model="password">
                    </div>

                    <div class="mr-3 mt-3">
                      <label for="confirm" class="block mb-2 text-md font-medium text-slate-500">Confirm Password</label>
                      <input class="border border-slate-500 text-black text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-[100%] px-4 py-[10px] placeholder:text-slate-300" type="password" required name="confirm" id="confirm" placeholder="e.g ineedadn123" v-model="passwordConfirm" value="{passwordConfirm}">
                    </div>
                    <div class="mt-9 flex flex-wrap gap-5 justify-center ">
